...
In this section of the course, you’ll learn about the foundational role of statistics in data science. This section focuses on fundamental concepts of descriptive statistics. You’ll also learn how quickly they summarize the dataset. You’ll also identify difference between descriptive and inferential stats.

### Module 2: Probability

You will learn about fundamental concepts in probability. The first half of this section covers basic rules of probability (addition, complement, multiplication), conditional probability, and Bayes's theorem. The other half consist of  three probability distributions: the binomial, Poisson, and normal distributions. 
...
In this section of the course, you will have the chance to demonstrate what you’ve learned in an end-of-course project. You will select a project or scenario and  you will use your knowledge of statistics to conduct a hypothesis test.
